...
topic_map: dict[str, TopicDescriptor] = {
    ...
    "N/+/settings/0/Settings/CGwacs/Hub4Mode": TopicDescriptor(
        message_type=MetricKind.SELECT,
        short_id="cgwacs_hub4mode",
        name="Hub4 mode",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
        device_type=DeviceType.SYSTEM,
    ...
    "N/+/settings/0/Settings/CGwacs/MaxFeedInPower": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="cgwacs_max_feed_in_power",
    ...
    "N/+/settings/0/Settings/CGwacs/PreventFeedback": TopicDescriptor(
        message_type=MetricKind.SWITCH,
        short_id="cgwacs_prevent_feedback",
        name="Prevent feedback",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
        device_type=DeviceType.GRID,
        value_type=ValueType.ENUM,
    ...
    "N/+/settings/0/Settings/CGwacs/AcPowerSetpoint": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="cgwacs_ac_power_setpoint",
    ...
    "N/+/settings/0/Settings/CGwacs/AcPowerSetpointPossible": TopicDescriptor(
        message_type=MetricKind.SWITCH,
        short_id="cgwacs_setpoint_possible",
        name="AC power setpoint possible",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
        device_type=DeviceType.GRID,
        value_type=ValueType.ENUM,
    ...
    "N/+/settings/0/Settings/CGwacs/AcPowerSetpointReturnDelay": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="cgwacs_setpoint_return_delay",
        name="AC power setpoint return delay",
    ...
    "N/+/settings/0/Settings/CGwacs/MaxChargePower": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="cgwacs_max_charge_power",
    ...
    "N/+/settings/0/Settings/CGwacs/MaxDischargePower": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="cgwacs_max_discharge_power",
    ...
    "N/+/settings/0/Settings/CGwacs/GridSetPoint": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="cgwacs_grid_setpoint",
        name="Grid setpoint",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    "N/+/settings/0/Settings/CGwacs/Sustain": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="cgwacs_sustain",
        name="Sustain time",
        unit_of_measurement="s",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
    ...
    "N/+/settings/0/Settings/Ess/Mode": TopicDescriptor(
        message_type=MetricKind.SELECT,
        short_id="ess_mode",
        name="ESS mode",
        metric_type=MetricType.NONE,
    ...
    "N/+/settings/0/Settings/Ess/MinimumSocLimit": TopicDescriptor(
        message_type=MetricKind.NUMBER,
        short_id="ess_min_soc_limit",
